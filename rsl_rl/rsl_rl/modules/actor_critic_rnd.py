...
class ActorCriticRND(ActorCritic):
    is_recurrent = False
    ...
    def __init__(self, num_actor_obs,
        ...
        for l in range(len(actor_hidden_dims)):
            if l == len(actor_hidden_dims) - 1:
                rnd_layers.append(nn.Linear(discriminator_hidden_dims[l], self.skill_dim))
            else:
                rnd_layers.append(nn.Linear(discriminator_hidden_dims[l], discriminator_hidden_dims[l + 1]))
                rnd_layers.append(activation)
